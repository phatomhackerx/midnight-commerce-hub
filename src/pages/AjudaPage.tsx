        ...
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          <div className="text-center space-y-6">
            <div>
              ...
              <p className="text-muted-foreground">Busque por tutoriais, guias e documentação</p>
            </div>
            ...
            <div className="max-w-2xl mx-auto relative">
              ...
              <Input 
                ...
                className="grok-input pl-12 h-14 text-lg"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {categories.map((cat) => (
                <Card key={cat.title} className="p-6 hover-lift cursor-pointer">
          ...
          <div>
            ...
            <div className="minimal-card divide-y divide-border">
